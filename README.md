...
-------
    git clone https://github.com/mohdimtiyaz002/Java-app-cicd.git
...
--------------
    docker build -t  mohdimtiyaz002/kubernetes-configmap-reload .
...
-----------
    docker push mohdimtiyaz002/kubernetes-configmap-reload
